...
namespace :html do
  ...
  task :generate => [:styles] do
    ...
    system("pandoc -s -S resume.markdown -o resume.html -t html5 --self-contained --section-divs --template=resume-template.html -T \"Chris Shelhorse's Resume\" -c css/main.css")
